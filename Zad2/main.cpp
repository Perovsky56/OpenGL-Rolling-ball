...
GLfloat odlegloscKamera = -55.0f;
GLfloat katKameraX = 25.0f;
	...
	int			nCmdShow)			// Window Show State
{
	...
	if (!CreateGLWindow("Zadanie nr 2 - rzut z odbiciem | Paweł Siemiginowski (s101450)", 800, 600, 16, fullscreen))
	{
